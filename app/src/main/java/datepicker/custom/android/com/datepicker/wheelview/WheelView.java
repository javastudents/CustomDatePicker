...
package datepicker.custom.android.com.datepicker.wheelview;
...
import datepicker.custom.android.com.datepicker.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View
{
    ...
    //间隔线的颜色，默认为灰色
    private int colorResource = R.color.province_line_border;
    // Wheel Values
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.datepicker_wheel_bg;
    private int wheelForeground = R.drawable.datepicker_wheel_val;
    ...
    public void setLineColor(int colorResource)
    {
